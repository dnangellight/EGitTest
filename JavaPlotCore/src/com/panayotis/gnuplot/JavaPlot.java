...
public class JavaPlot extends GNUPlot {
	 ...
	 *             If the gnuplot executable is not found, this exception is
	 *             thrown. Typically at this case there is need to use a
	 *             constructor which defines the gnuplot path.
	 * @see GNUPlot#GNUPlot()
	 */
	 ...
	 *             constructor which defines the gnuplot path.
	 * @param isGraph3D
	 *            true if the default plot is Graph3D
	 ...
	 * @param gnuplotpath
	 * @throws com.panayotis.gnuplot.GNUPlotException
	 *             We need pgnuplot.exe for version 4.8.2 !
	 *              If the gnuplot executable is not found, this exception is
	 *             thrown. It means that the provided path for gnuplot is not
	 *             valid.
	 ...
	 * 
	 * @param gnuplotpath
	 *            The pathname of the gnuplot executable. If this parameter is
	 ...
	 */
	public JavaPlot(String gnuplotpath, boolean isGraph3D)
	 ...
	 */
	public JavaPlot(GNUPlotParameters par, String gnuplotpath,
			GNUPlotTerminal term) throws GNUPlotException {
	 ...
	 */
	public JavaPlot(GNUPlotParameters par, String gnuplotpath,
			GNUPlotTerminal term, boolean isGraph3D) throws GNUPlotException {
