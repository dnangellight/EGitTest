...
class User_model extends MY_Model {
	...
	public $rules_admin = array (
			...
			'password' => array('field'=>'password','label'=>'Password','rules'=>'matches[password_confirm]|trim'),
			'password_confirm' => array('field'=>'password_confirm','label'=>'Confirm Password','rules'=>'matches[password]|trim')
	);
	...
	public function login(){
		...
		//dump($this->hash($this->input->post('password')));
		if (count($user) ) {
			$data = array(
